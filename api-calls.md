...
- **参数**: 无
- **状态**: ✅ **已完善** - 合约账户余额显示和资金用途说明 (2025-09-08)
...
- **修复内容**:
  ...
  - 修复总价值计算逻辑
  - **新增保证金状态显示**: 区分总价值、可用保证金、占用保证金
  - **新增资金用途说明**: 详细解释现货余额和合约账户的使用场景
  - **智能余额提示**: 帮助用户理解为什么有钱却不能交易的原因
...
- **状态**: ✅ **已修复** - 杠杆交易保证金检查逻辑完善 (2025-09-08)
- **修复内容**: 
  - 添加前端$10最小金额验证，防止无效请求
  - 改进API响应处理，只有真正成功才显示成功消息
  - **新增杠杆交易保证金检查**: 区分现货(1x)和合约(>1x)资金使用
  - **智能错误提示**: 详细解释保证金占用、可用额度等问题
  - **资金用途说明**: 明确解释现货余额用于1x交易，合约账户用于杠杆交易
  - 提供具体解决方案和交易金额建议
